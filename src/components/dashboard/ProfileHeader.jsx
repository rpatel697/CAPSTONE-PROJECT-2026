...
export default function ProfileHeader({ setActivePage }) {
  return (
            ...
            <div className="flex flex-col items-center text-center">
             ...
             <div className="flex h-[150px] w-[150px] items-center justify-center rounded-full bg-[#2D2A3A] ring-4 ring-white shadow-[0_0_30px_rgba(255,56,100,0.50)] overflow-hidden">
              ...
              onClick={() => setActivePage("editProfile")}
               className="mt-6 w-full rounded-2xl bg-[#FF3864] px-4 py-3 text-sm font-bold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-[#e7335b] shadow-[0_5px_20px_rgba(34,31,53,0.40)]">
                Edit Profile
              </button>
