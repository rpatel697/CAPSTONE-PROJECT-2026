import { Menu, Telescope, Handshake, Rocket, Flame, Zap, Mail, Bell } from "lucide-react";
      ...
      />
        ...
        <div className="flex items-center justify-center gap-2">
          <button className="group flex items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-[#5F667A] transition-all duration-200 hover:bg-[#F2F7FF] hover:text-[#4C7ECF] hover:-translate-y-[1px] cursor-pointer">
            <Telescope className="h-[17px] w-[17px] text-[#7C8DB5] transition-all duration-200 group-hover:scale-110 group-hover:rotate-12 group-hover:text-[#4C7ECF]" />
            <span>Explore</span>
          </button>
