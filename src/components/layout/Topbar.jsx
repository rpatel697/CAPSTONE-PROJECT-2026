...
export default function Topbar() {
  ...
  />
        ...
        <div className="flex items-center gap-2  border border-[#DCDCDC] rounded-full bg-[#F7F7FB] px-1.5 py-1.5">
          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#2D2A3A] text-[20px]">
            🦊
          </div>
